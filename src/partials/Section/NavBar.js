    ...
    return (
        <nav className="flex flex-wrap p-6">
            ...
            <div className="flex items-center gap-8 flex-shrink-0 text-white mr-6 lg:mr-72">
                ...
                <a className="tracking-widest hover:text-yellow-500">HOME</a>
                <a className="tracking-widest hover:text-yellow-500">ABOUT</a>
                <a className="tracking-widest hover:text-yellow-500">INFRASTRUCTURE</a>
                <a className="tracking-widest hover:text-yellow-500">SUSTAINABILITY</a>
                <a className="tracking-widest hover:text-yellow-500">PRODUCT</a>
