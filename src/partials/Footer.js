  ...
  return (
    ...
    <footer class="footer ">
      <div class="container  px-32">
        <div class="flex justify-between row gx-5 pt-[52px]">
          <div class="col-12 mt-12 w-40 md:col-6 lg:col-3">
            <a href="#">
              <img src="images/Logo-1.png" alt="" />
            </a>
            <div class="pl-4 col-12 mt-12 md:col-6 lg:col-3">
            <ul class=" flex space-between social-icons mt-4 lg:mt-6">
              <li>
                <a href="#">
                  <svg
                    width="19"
          ...
          <div class="col-12 mt-12 md:col-6 text-left  lg:col-3">
            <h6 className="font-bold">Other Pages</h6>
            <ul className="p-3 text-gray-500">
              <li >
                <a href="#">Home</a>
              </li>
              <li >
          ...
          <div class="col-12 mt-12 md:col-6 text-left font-bold lg:col-2">
            <h6>Latest Products</h6>
           
            <div class="key-feature-grid  grid grid-cols-2 gap-7  md:grid-cols-3 xl:grid-cols-4">
                    <div class="flex flex-col justify-between rounded-lg bg-white ">
                        <span class="icon mt-4">
                            <img class="objec-contain h-20 w-32" src="images/products/p-1.jpg"   alt="" />
                        </span>
                    </div>
                    <div class="flex flex-col justify-between rounded-lg bg-white">
                        <span class="icon mt-4">
                            <img class="objec-contain h-20 w-32" src="images/products/p-2.jpg" alt="" />
                        </span>
                    </div>
                    <div class="flex flex-col justify-between rounded-lg bg-white  ">
                        
                        <span class="icon mt-4">
                            <img class="objec-contain h-20 w-32" src="images/products/p-3.jpg" alt="" />
                        </span>
                    </div>
                    <div class="flex flex-col justify-between rounded-lg bg-white ">
                       
                        <span class="icon mt-4">
                            <img class="objec-contain h-20 w-32" src="images/products/p-4.jpg" alt="" />
                        </span>
                    </div>
                    <div class="flex flex-col justify-between rounded-lg bg-white ">
                     
                        <span class="icon mt-4">
                            <img class="objec-contain h-20 w-32" src="images/products/p-5.jpg" alt="" />
                        </span>
                    </div>
                    <div class="flex flex-col justify-between rounded-lg bg-white ">
                       
                        <span class="icon mt-4">
                            <img class="objec-contain h-20 w-32" src="images/products/p-6.jpg" alt="" />
                        </span>
                    </div>
                    <div class="flex flex-col justify-between rounded-lg bg-white ">
                        
                        <span class="icon mt-4">
                            <img class="objec-contain h-20 w-32" src="images/products/p-7.jpg" alt="" />
                        </span>
                    </div>
                    <div class="flex flex-col justify-between rounded-lg bg-white ">
                        <span class="icon mt-4">
                            <img class="objec-contain h-20 w-32" src="images/products/p-8.jpg" alt="" />
                        </span>
                    </div>
                </div>
          </div>
      ...
      <div class=" px-32 text-gray-500 h-2 max-w-[1440px]">
        <div
          class="flex justify-between  mx-auto border-t border-border pb-10 pt-7 text-center"
        >
          <p>Developed by YRP IT SOLUTIONS</p>
          <p className="">Copyright © 2022. All rights reserve</p>
        </div>
      </div>
    </footer>
  );
